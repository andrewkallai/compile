...
I=$(($SLURM_ARRAY_TASK_ID*80+1))
STOP=$(($I+80-1))
if [ $STOP -gt 31653 ]; then
  STOP=31653
fi
cd /tmp
...
make -f /home/3302/hf_py_code/compile/codes/batch_jobs/makefile_dir/no_ignore_error_makefile -j 64 lang=c begin=$I end=$STOP
